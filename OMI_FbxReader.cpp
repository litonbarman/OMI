...
namespace OMI {
	...
	OMI_FbxReader::OMI_FbxReader(){
		this->version = 0.01;
	}
	
	void OMI_FbxReader::read(string fname){
	...
	void OMI_FbxReader::write(string fname){
	...
	bool checkMagic(OMI_FbxFileReader &reader){
	...
	void OMI_FbxReader::read(std::ifstream &input){
	...
	namespace {
		...
		void writerFooter(OMI_FbxFileWriter &writer) {
			...
			for(unsigned int i = 0; i < sizeof(footer); i++) {
                OMI_FbxFilewriter.write(footer[i]);
            }
        }
	...
	void OMI_FbxReader::write(std::ofstream &output){
		
        OMI_FbxFileWriter writer(&output);
        ...
        for(OMI_FbxNode node : nodes) {
            offset += node.write(output, offset);
        }
        
		OMI_OMI_FbxNode nullNode;
	...
	void OMI_FbxReader::createBasicStructure(){
		
        OMI_OMI_FbxNode headerExtension("FBXHeaderExtension");
		...
		{
            OMI_OMI_FbxNode creationTimeStamp("CreationTimeStamp");
		...
		{
            OMI_OMI_FbxNode sceneInfo("SceneInfo");
		    ...
		    {
                OMI_OMI_FbxNode metadata("MetaData");
		    ...
		    {
                OMI_FbxNode properties("Properties70");
                {
                    OMI_OMI_FbxNode p("P");
	...
	std::uint32_t OMI_FbxReader::getVersion(){
        return version;
    }

    void OMI_FbxReader::print(){
